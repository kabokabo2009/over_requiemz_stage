(function () {
  ...
  const castData = {
    "01": { photo: "images/cast-01.webp", name: "丸山 龍星", role: "カイゼ・オズマ 役" },
    ...
    "09": { photo: "images/cast-09.webp", name: "柳堀 花怜(僕が見たかった青空)", role: "グリンダ・フェリス 役" },
    "10": { photo: "images/cast-10.webp", name: "馬場 良馬", role: "オッサー・ウッドランド 役" }
  };
